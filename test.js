...

{
	...
	const coefficient = 0x6823D79A48C9FE97CD565CE5541E7CE1DD9C01E06B93CB13175CD3A1BA215DD33E0B280321F7D678C509AA4A81245EC7CCE0A3E97E162317F6F021C3F980E7A2n
	const options = {modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient}
	const actual = rsaPrivateKey.pkcs8(options)
	const expected =
		'-----BEGIN PRIVATE KEY-----\n' +
		'MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAPHfB3Omrau/CbdR\n' +
		'y6fWoAP8KUH7Bb5GFHWdWLHbzpC9o2p48B0IDDAsvzY2pdxVBFtDiz3mymVCfC+O\n' +
		'CQV0pVcVOM8ookjlpXfBJE3rUQFU91ikKt7nfnJ8b+4PKxkUKdVB2cJnW2dcBHwG\n' +
		'KvEI2MeptXIjIEaOw2g0IQ9vZHflAgMBAAECgYEAk16b0Lh+2sU0a1DYMHRR3Pu4\n' +
		'O65x6mQStTLgxsWxz3jsZ8Q2MMolevjYrHSRjHT0iZLW9Sl4qkffGK6HCp7u2bgW\n' +
		'wIGDhNipCV7XijHGbtM14HDAYLc4HuGKiRtoCNs9nWEC42zqazdhu++PoubHPHja\n' +
		'bw7kNcIbb9/4oy9o1SECQQD96Ss6xaQ2hb3afeb6ax1W7F56TgHzsShM63MJdvV3\n' +
		'JshlRW/gnjxUCIzjeGFkdZlyTZugP+GHCMIzk1Z3ihjpAkEA89yAFU101lJnyFHi\n' +
		'iAjifPBatCGX0xFuqq186fZMr+2My/XQAuCU+afdJo9I1E8oPaGgtsW4cURGVxLv\n' +
		'2lsJnQJBAKFfc+4idr+AOK2InyhAs6DvEQzCT1NGIMriSXaWeGOF7o8OlpA3gTgX\n' +
		'RxO7CosCgse2s1Yhw4BC/Moyth27UyECQGYS3eoMyeMMCzTmUZPvZB433T+Y8BwB\n' +
		'J/l5NNgZqG/bVxvogHEz4CfAA+moACweFhH2HXdju5hto6O+4XbctGECQGgj15pI\n' +
		'yf6XzVZc5VQefOHdnAHga5PLExdc06G6IV3TPgsoAyH31njFCapKgSRex8zgo+l+\n' +
		'FiMX9vAhw/mA56I=\n' +
		'-----END PRIVATE KEY-----'
	assert.strictEqual(actual, expected)
}
